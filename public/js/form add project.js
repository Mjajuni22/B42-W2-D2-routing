    ...
    document.getElementById("contents").innerHTML += `
            <div class="col-12 col-md-6 col-lg-4 p-2">
             <div class="card p-3 shadow">
                ...
                <div class="card-body">
                <a href="/detail-project" class="text-dark text-decoration-none">
                    <h3 class="card-title">${dataBlog[i].title}</h3>
                    <p class="font-weight-light text-muted"> Jangka Waktu : ${
                      dataBlog[i].waktu.bulan
                    } Bulan atau ${dataBlog[i].waktu.hari} Hari</p>
                    <p class="card-text">${dataBlog[i].content}</p>
                </a>
            <h3>
            ${dataBlog[i].nodejs ? `<i class="fs-1 uil-vuejs"></i>` : ``}
            ${dataBlog[i].reactjs ? `<i class="fs-1 uil-react"></i>` : ``}
            ${dataBlog[i].nextjs ? `<i class="fs-1 uil-java-script"></i>` : ``}
            ${dataBlog[i].typescript ? `<i class="fs-1 uil-github"></i>` : ``}
            </h3>
